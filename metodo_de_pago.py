...
"""
Interfaz para la gestión de métodos de pago
"""
def interfaz_metodo_pago():
    ventana = Tk()
    ventana.title("Método de Pago")
    ventana.geometry("800x600")
    crear_seccion_metodo_pago(ventana, None).pack(expand=True, fill="both")
    ventana.mainloop()
...
def crear_seccion_metodo_pago(ventana, barra_lateral):
    ...
    Label(frame_izquierdo, text="Metodo de pago", font=("Arial", 16, "bold"), bg="#E6F0FA").pack(pady=10)
